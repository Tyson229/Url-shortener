  ...
  return (
    <section className={`w-full bg-slate-200 mt-32 -mb-12 flex justify-center`}>
      <div className={`${layoutStyle} relative`}>
        <div className="bg-shorten-mobile md:bg-shorten-desktop bg-contain bg-no-repeat bg-right md:bg-cover md:bg-left-top bg-violet-950 py-5 px-6 md:px-12 md:py-10 rounded-md flex flex-col md:flex-row gap-4 md:gap-6 relative -top-24">
          <input
